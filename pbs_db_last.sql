...
INSERT INTO `activity_log` VALUES (197, 1, 'ADD_ADMIN', 'Menambahkan admin baru: john (admin)', '::1', '2026-06-02 22:11:01');
INSERT INTO `activity_log` VALUES (198, 1, 'UPDATE_SETTINGS', 'Memperbarui pengaturan situs (1 perubahan)\n[Nama Situs] \"PT. Prima Bahari Sejahtera\" → \"PT. Prima Bahari\"', '::1', '2026-06-07 15:41:40');
INSERT INTO `activity_log` VALUES (199, 1, 'ADD_SERVICE', 'FCL 2', '::1', '2026-06-07 15:42:32');
INSERT INTO `activity_log` VALUES (200, 1, 'UPDATE_SERVICE', 'FCL 2', '::1', '2026-06-07 15:42:54');
INSERT INTO `activity_log` VALUES (201, 1, 'DELETE_ROUTE', 'Menghapus rute\n[Rute] Batam → Medan\n[ID] 4', '::1', '2026-06-07 15:43:25');
INSERT INTO `activity_log` VALUES (202, 1, 'UPDATE_SETTINGS', 'Memperbarui pengaturan situs (1 perubahan)\n[SMTP Gmail] \"leonardojaylenson28@gmail.com\" → \"\"', '::1', '2026-06-07 18:00:17');
...
-- Records of admins
-- ----------------------------
INSERT INTO `admins` VALUES (1, 'admin', 'admin@primabaharisejahtera.co.id', '$2y$10$5BhofHljl7hLgZ/gvtAJgOeY4lLLakOrI8/UOTI743sM33e0XrPce', 'Super Administrator', 'superadmin', NULL, '2026-06-07 18:00:03', '2026-05-06 19:56:39');
...
INSERT INTO `admins` VALUES (3, 'john', 'john@gmail.com', '$2y$10$m/3jJkjcu3mAyjgWyFSYBeataXs0XSl8CxbU2jRuqCTvSdr3dQd1m', 'john', 'admin', NULL, NULL, '2026-06-02 22:11:01');
...
INSERT INTO `messages` VALUES (7, 'leo', 'leonardojylns@gmail.com', '0821', 'saya ingin bertanya', 'mau bertanya', 'FCL (Full Container Load)', 1, 1, 1, '2026-06-07 15:40:20');
...
-- Records of services
-- ----------------------------
INSERT INTO `services` VALUES (1, 'Lost Cargo / LCL', 'lost-cargo-lcl', 'bi-box-seam', 'uploads/services/pbs_6a1b0fc5170cd4.74661142.png', 'Layanan pengiriman muatan satuan (Less than Container Load) yang ekonomis untuk berbagai jenis barang.', '', '[\"Biaya lebih ekonomis untuk muatan kecil\",\"Pengiriman ke seluruh wilayah Indonesia\",\"Pengemasan profesional & aman\",\"Tracking real-time\",\"Asuransi pengiriman tersedia\",\"Pickup & delivery tersedia\"]', 1, 1, 1, '2026-05-06 19:56:39', '2026-06-07 15:42:21');
...
INSERT INTO `services` VALUES (7, 'FCL 2', '', 'bi-box-seam', 'uploads/services/pbs_6a252f0e6f1210.11393565.png', 'DESCRIPTION', '', '[]', 0, 1, 0, '2026-06-07 15:42:32', '2026-06-07 15:42:54');
...
) ENGINE = InnoDB AUTO_INCREMENT = 4143 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of settings
-- ----------------------------
INSERT INTO `settings` VALUES (1, 'site_name', 'PT. Prima Bahari', '2026-05-06 19:56:39', '2026-06-07 15:41:40');
...
INSERT INTO `settings` VALUES (2189, 'smtp_gmail', '', '2026-05-25 22:59:47', '2026-06-07 18:00:17');
INSERT INTO `settings` VALUES (2190, 'smtp_app_password', '', '2026-05-25 22:59:47', '2026-06-07 18:00:17');
